...
<head>
  ...
  <script type="text/javascript" src="/assets/javascript/myPlugin.js"></script>
    ...
    <nav class="navbar navbar-inverse navbar-static-top">
     ...
     <div class="collapse navbar-collapse" id="top-bar-collapse">
       ...
       <ul class="nav navbar-nav">
        ...
        <li><a href="/insight/channels"><span class="fa fa-user fa-inverse"></span> 實況主</a></li>

        <li><a href="/insight/games"><span class="fa fa-gamepad fa-inverse"></span> 遊戲</a></li>

      </ul>

      <ul class="nav navbar-nav navbar-right" style="right:5%;">

        <form class="navbar-form navbar-left" role="search" action="/search/result" target="_self" method="POST">
